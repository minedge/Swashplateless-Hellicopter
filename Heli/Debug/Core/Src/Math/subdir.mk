...
C_SRCS += \
../Core/Src/Math/novus_math.c 

OBJS += \
./Core/Src/Math/novus_math.o 

C_DEPS += \
./Core/Src/Math/novus_math.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/Math/%.o: ../Core/Src/Math/%.c Core/Src/Math/subdir.mk
...
clean-Core-2f-Src-2f-Math:
	-$(RM) ./Core/Src/Math/novus_math.d ./Core/Src/Math/novus_math.o
