...
/* Private defines -----------------------------------------------------------*/
#define TMTC_TX_Pin GPIO_PIN_2
#define TMTC_TX_GPIO_Port GPIOA
#define TMTC_RX_Pin GPIO_PIN_3
#define TMTC_RX_GPIO_Port GPIOA
...
#define NOT_USE_Pin GPIO_PIN_6
#define NOT_USE_GPIO_Port GPIOB
